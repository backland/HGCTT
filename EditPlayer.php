...
if (isset($_POST["cmdUpdate"])) {
    ...
    if ($Password=="G0lf@HGCTT") {
     ...
     mysqli_stmt_bind_param($stmt, 'issssiisi', $MemberNo,$Name,$Given, $Surname, $Email,$Wednesday,$Saturday,$Mobile,$ID);
     mysqli_stmt_execute($stmt);
     header("Location: Players.php");
     exit();
   } else {
     $error_msg="<h3 class='text-center'>INVALID PASSWORD</h3>";
   }
}
...
<ul class="list-group">
  ...
  <li class="list-group-item"><label>Mobile </label>
   <input size=40 class='form-control' id=Mobile name=Mobile type=text value='<?php echo $player[9]; ?>'></li>    
  ...
  <li class="list-group-item"><label>Password</label>
   <input size=40 class='form-control' id=Password name=Password type=password value=''></li>    
  </ul>
